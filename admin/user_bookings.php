...
<body class="bg-light">
        ...
        <div class="card border-0 shadow-sm mb-4">
          <div class="card-body">
            ...
            <div class="text-end mb-4">
              <input type="text" oninput="get_bookings(this.value)" class="form-control shadow-none w-25 ms-auto" placeholder="Tìm kiếm theo tên khách hàng...">
            </div>
  ...
  <script src="scripts/user_bookings.js"></script>
