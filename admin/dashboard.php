...
<head>
  ...
  <title>Admin Panel - Thống Kê</title>
...
<body class="bg-light">
  ...
  // // kiểm tra kết quả truy vấn
  // if ($result2) {
  //     // kết quả dưới dạng mảng kết hợp (associative array)
  //     $row = mysqli_fetch_assoc($result2);
  //     // lấy tổng doanh thu
  //     $tong_doanhthu = $row['tong_doanhthu'];
  //     // in ra tổng doanh thu
      ...
      <div class="col-lg-10 ms-auto p-4 overflow-hidden">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
          ...
          if ($is_shutdown['shutdown']) {
            echo <<<data
                <h6 class="badge bg-danger py-2 px-3 rounded">Máy chủ đã dừng hoạt động!</h6>
              data;
          }
          ?>
        </div>
