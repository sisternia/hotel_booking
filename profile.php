...
<body class="bg-light">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-8 mb-5 px-4 info-form">
        <div class="bg-white p-3 p-md-4 rounded shadow-sm">
          <form id="info-form">
            <h5 class="mb-3 fw-bold text-center">Thông tin cơ bản</h5>
            <div class="row">
        ...
        <div class="bg-white p-3 p-md-4 mt-4 rounded shadow-sm">
          <form id="pass-form">
            <h5 class="mb-3 fw-bold text-center">Đổi Mật Khẩu</h5>
            <div class="row">
              <div class="col-md-6 mb-4">
